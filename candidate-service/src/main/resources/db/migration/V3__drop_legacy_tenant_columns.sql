...
BEGIN
    FOREACH tbl_name IN ARRAY ARRAY['candidate', 'custom_field_definition'] LOOP
        IF EXISTS (SELECT 1 FROM information_schema.columns c
            ...
            IF table_tenant IS NOT NULL THEN
                ...
                ELSIF selected_tenant <> table_tenant THEN
                    RAISE EXCEPTION 'Phase 10 found inconsistent legacy tenant IDs in candidate data. Reconcile and back up data first.';
                END IF;
            END IF;
