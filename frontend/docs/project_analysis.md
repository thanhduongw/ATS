...
> [!WARNING]
> **TÀI LIỆU LỊCH SỬ - OUTDATED.** Nội dung được lập trước refactor
> single-company và có thể còn mô tả multi-tenancy/role cũ. Nguồn hiện hành là
> `README.md` và `ATS_CURRENT_ARCHITECTURE.md`.
