                ...
                <Col xs={24} sm={8}>
                    <Card style={{ textAlign: "center", border: "none" }} className="stat-card">
                        ...
                        >
                            ...
                            <span style={{ fontSize: 32, fontWeight: 700, color: COLORS.success }}>
                ...
                <Col xs={24} sm={8}>
                    <Card style={{ textAlign: "center", border: "none" }} className="stat-card">
                        ...
                        >
                            ...
                            <span style={{ fontSize: 32, fontWeight: 700, color: COLORS.error }}>
                        ...
                        {funnelSteps.map((step, idx) => {
                            ...
                            const conv =
                                prev != null && prev > 0
                                    ...
                                    : null;
                            const heightPct = Math.max(18, Math.round((step.value / funnelMax) * 100));
