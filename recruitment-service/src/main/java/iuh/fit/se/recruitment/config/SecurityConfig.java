...
import iuh.fit.se.recruitment.security.TrustedHeaderAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/error", "/swagger-ui/**", "/v3/api-docs/**",
                                "/api/recruitment/v3/api-docs/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/recruitment/public/**").permitAll()
